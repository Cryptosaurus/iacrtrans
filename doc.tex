% IACR Transactions CLASS DOCUMENTATION -- version 0.23 (26 May 2016)
...
\paragraph{Note:} If there are fragile commands in the title, author, or
keywords, they should either be \verb+\protect+-ed, or you should give a
non-fragile optional argument.  For instance, use
\verb+\title{Crypto with \protect\LaTeX}+ or
\verb+\title[Crypto with \LaTeX]{Crypto with \LaTeX}+.
...
\item[v 0.23] More documentation.  Removed some extra line-numbers
  ...
  keyword).  Optional argument for \verb+\email+.
\end{description}

% IACR Transactions CLASS DOCUMENTATION -- version 0.22 (10 May 2016)
...
We recommend the \texttt{booktabs} package to typeset taables.
...
\begin{itemize}
\item \href{http://ctan.org/pkg/geometry}{\texttt{geometry}}, \href{http://ctan.org/pkg/secsty}{\texttt{secsty}}, \href{http://ctan.org/pkg/fancyhdr}{\texttt{fancyhdr}}, \href{http://ctan.org/pkg/mathtools}{\texttt{mathtools}},
